...
export const IconButton = styled.button`
    ...
    border: none;
    border-radius: 50%;
    background-image: ${props => props.icon ? `url(${props.icon})` : `url(${add})`};
    ...
    &:hover, &:focus, &:active {
        background-color: ${props => {
            ...
            if (props.bgcolor === "secondary") return props.theme.palette.secondary.light;
            return props.theme.palette.default.dark;
        }};
        outline: 0;
    };
    box-shadow: ${props => {
        if (props.raised === 1) return "0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23)";
        return "none";
    }};
`
